    ...
    <div>
      ...
      <div className="sticky-menu">
        <nav className="menu-navbar">
          <button
            type="button"
            className={`${cartButtonClicked ? 'menu-svg-button clicked' : 'menu-svg-button'}`} onClick={handleCartButtonClick}>
          ...
          <button className="menu-svg-button">
            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M12.0049 16.005L12.0049 15.995" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M12.0049 12.005L12.0049 11.995" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              <path d="M12.0049 8.005L12.0049 7.995" stroke="#323232" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
            </svg>
          </button>
          ...
          <button className="menu-svg-button">
            <svg width="24px" height="24px" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
              ...
              <path d="M15.6309 7.15517C15.9015 7.05482 16.1943 7 16.4999 7C17.8806 7 18.9999 8.11929 18.9999 9.5C18.9999 10.8807 17.8806 12 16.4999 12C16.1943 12 15.9015 11.9452 15.6309 11.8448" stroke="#323232" stroke-width="2" stroke-linecap="round" />
              <path d="M3 19C3.69137 16.6928 5.46998 16 9.5 16C13.53 16 15.3086 16.6928 16 19" stroke="#323232" stroke-width="2" stroke-linecap="round" />
              <path d="M17 15C19.403 15.095 20.5292 15.6383 21 17" stroke="#323232" stroke-width="2" stroke-linecap="round" />
